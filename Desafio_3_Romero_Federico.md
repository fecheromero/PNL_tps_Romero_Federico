...
| **GRU**  | 7.16 | 9.08 | 1.6391 | `...my soul the street` | Estable / Involutivo |
| **LSTM**  | 8.50 | 12.4 | 2.1913 | `...the the the the the` | Overfit |
| **Doble GRU** | **6.49** | 9.3 | 1.9735 | `...you the the the the` | Overfit |
| **LstmEmbed** | 6.84 | 11.8 | 0.0497 | `...my head to stay to the start` | **Máxima Coherencia** |
| **ConvAtten** | 7.82 | 9.4 | 0.0643 | `...me for me the for me` | Overfit |
